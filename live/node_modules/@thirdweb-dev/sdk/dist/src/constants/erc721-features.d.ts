export declare const FEATURE_NFT_REVEALABLE: {
    ...
    readonly docLinks: {
        ...
        readonly contracts: "IDelayedReveal";
    };
...
export declare const FEATURE_NFT_CLAIM_CONDITIONS: {
    readonly name: "ERC721ClaimConditions";
    readonly namespace: "nft.drop.claimConditions";
    readonly docLinks: {
        readonly sdk: "sdk.dropClaimConditions";
        readonly contracts: "IClaimConditions";
    };
    readonly abis: readonly [({
        anonymous: boolean;
        inputs: {
