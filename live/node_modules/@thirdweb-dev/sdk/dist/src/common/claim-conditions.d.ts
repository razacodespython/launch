 ...
 */
export declare function prepareClaim(quantity: BigNumberish, activeClaimCondition: ClaimCondition, merkleMetadata: Record<string, string>, tokenDecimals: number, contractWrapper: ContractWrapper<any>, storage: IStorage, proofs: BytesLike[], checkERC20Allowance: boolean): Promise<ClaimVerification>;
/**
 * @internal
 * @param merkleRoot
