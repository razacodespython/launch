...
export interface SignatureDropInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "verifyClaimMerkleProof", values: [string, BigNumberish, IDrop.AllowlistProofStruct]): string;
...
export interface SignatureDrop extends BaseContract {
    ...
    functions: {
        ...
        getRevealURI(_batchId: BigNumberish, _key: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        verifyClaimMerkleProof(_claimer: string, _quantity: BigNumberish, _allowlistProof: IDrop.AllowlistProofStruct, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
    ...
    estimateGas: {
        ...
        verifyClaimMerkleProof(_claimer: string, _quantity: BigNumberish, _allowlistProof: IDrop.AllowlistProofStruct, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        verifyClaimMerkleProof(_claimer: string, _quantity: BigNumberish, _allowlistProof: IDrop.AllowlistProofStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
