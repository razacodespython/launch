...
export interface DropInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "claim" | "claimCondition" | "getActiveClaimConditionId" | "getBaseURICount" | "getBatchIdAtIndex" | "getClaimConditionById" | "getClaimTimestamp" | "lazyMint" | "setClaimConditions" | "verifyClaim" | "verifyClaimMerkleProof"): FunctionFragment;
